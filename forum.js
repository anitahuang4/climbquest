...
async function submitReply() {
  ...
  await supabase.rpc('increment_reply_count', { thread_id: activeThreadId });
...
async function handleUpvote(btn) {
  ...
  await supabase.rpc('increment_upvotes', { thread_id: id, delta });
}
...
async function submitThread() {
  ...
  newThreadBtn.textContent = 'New post';
